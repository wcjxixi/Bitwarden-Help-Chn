...
* **内置 TOTP**：相当于内置了一个类似 [Authy](https://authy.com/) 这样的两步验证管理工具，这样就不需要再单独安装两步验证 App 了，并且支持在自动填充登录后将 TOTP 自动复制到剪贴板。
...
| ---- | ---------- | ---------- | ---------- | ---------- | ---------- |
| 初始价格 | $1.00/月    | $5.00/月    | $3.00/用户/月 | $8.00/月    | $4.00/用户/月 |
| 附加用户 | 不支持        | $2.00/用户/月 | $3.00/用户/月 | $2.50/用户/月 | $4.00/用户/月 |
...
| 项目   | 家庭版（仅年付）   | 团队版年付      | 企业版年付      | 团队版月付      | 企业版月付      |
| ---- | ---------- | ---------- | ---------- | ---------- | ---------- |
| 初始价格 | $3.99/月    | $4.00/用户/月 | $6.00/用户/月 | $5.00/用户/月 | $7.00/用户/月 |
| 附加用户 | 不支持        | $4.00/用户/月 | $6.00/用户/月 | $5.00/用户/月 | $7.00/用户/月 |
| 附加存储 | $0.33/GB/月 | $0.33/GB/月 | $0.33/GB/月 | $0.50/GB/月 | $0.50/GB/月 |
