...
* [管理控制台](docs/admin-console/README.md)
  ...
  * [SSO 登录](docs/admin-console/login-with-sso/README.md)
    ...
    * [SSO 指南](docs/admin-console/login-with-sso/sso-guides/README.md)
      ...
      * [ADFS SAML](docs/admin-console/login-with-sso/sso-guides/adfs-saml.md)
      * [ADFS OIDC](docs/admin-console/login-with-sso/sso-guides/pingfederate-saml.md)
      * [Auth0 SAML](docs/admin-console/login-with-sso/sso-guides/auth0-saml.md)
      * [AWS SAML](docs/admin-console/login-with-sso/sso-guides/aws-saml.md)
      * [Cloudflare Zero Trust SSO](docs/admin-console/login-with-sso/sso-guides/cloudflare-zero-trust-sso.md)
      * [Duo SAML](docs/admin-console/login-with-sso/sso-guides/duo-saml.md)
      * [Google SAML](docs/admin-console/login-with-sso/sso-guides/google-saml.md)
      * [JumpCloud SAML](docs/admin-console/login-with-sso/sso-guides/jumpcloud-saml.md)
      * [Keycloak SAML](docs/admin-console/login-with-sso/sso-guides/keycloak-saml.md)
      * [Microsoft Entra ID SAML](docs/admin-console/login-with-sso/sso-guides/microsoft-entra-id-saml.md)
      * [Microsoft Entra ID OIDC](docs/admin-console/login-with-sso/sso-guides/microsoft-entra-id-oidc.md)
      * [Okta SAML](docs/admin-console/login-with-sso/sso-guides/okta-saml.md)
      * [Okta OIDC](docs/admin-console/login-with-sso/sso-guides/okta-oidc.md)
      * [OneLogin SAML](docs/admin-console/login-with-sso/sso-guides/onelogin-saml.md)
      * [Ping Identity SAML](docs/admin-console/login-with-sso/sso-guides/ping-identity-saml.md)
      * [Ping Identity OIDC](docs/admin-console/login-with-sso/sso-guides/ping-identity-oidc.md)
