...
{% hint style="info" %}
个人密码库项目和所有 Send 的附件使用高级订阅或组织授予的个人存储空间。组织拥有的项目上的附件使用共享的组织存储空间。了解如何[添加存储空间](../password-manager/your-vault/vault-items/file-attachments.md#add-storage-space)。
{% endhint %}
