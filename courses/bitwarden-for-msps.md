...
| 20 | SSO 登录 | <p>如适用，配置 SSO 登录和组织标识符<br>配置以与 SAML 2.0 或 OpenID Connect 协同工作</p>                                             | [开始使用 SSO](../docs/admin-console/login-with-sso/about-sso.md)                         | 1.5      |
...
| 25 | SSO 登录        | 如适用，配置 Bitwarden 使用您的 SAML 2.0 或 OIDC 身份提供程序进行身份验证                                           | [关于 SSO](../docs/admin-console/login-with-sso/about-sso.md)                                                                                                                                                                                                                                              | 1.5      |
