...
{% tab title="企业版" %}
{% hint style="success" %}
您还可以[观看演示](admin.md#watch-a-demo)、参加公共[培训课程](https://bitwarden.com/events/tag/demo/)或查看有用的[入职资源](admin.md#onboarding-resources)。
...
* 设置[策略](../../admin-console/oversight-visibility/enterprise-policies.md)以执行用户安全规则，例如强制使用两步登录。
* 审计[组织成员拥有哪些凭据的访问权限](../../password-manager/your-vault/security-tools/vault-health-reports.md#member-access)。
...
* 将 Bitwarden 与现有的 SIEM 工具（如 [Microsoft Sentinel](../../admin-console/oversight-visibility/siem-integrations/microsoft-sentinel-siem.md)）集成。
...
详细了解当企业组织配置为[受信任设备加密的 SSO](../../admin-console/login-with-sso/trusted-devices/about-trusted-devices.md) 时，用户将如何体验 SSO 登录流程。
...
[此处](../../admin-console/login-with-sso/claimed-domains.md)了解更多有关域验证的信息。
...
[此处](../../admin-console/more/organization-sponsored-families-plans.md)了解更多有关企业赞助的家庭组织的信息。
...
[此处](../../plans-and-pricing/password-manager/about-bitwarden-plans.md)了解更多有关可用的 Bitwarden 计划的信息。
...
<a href="../../admin-console/onboarding/customer-success-hub.md" class="button primary">访问成功中心</a>
...
<a href="../../admin-console/onboarding/bitwarden-onboarding-playbook.md" class="button primary">访问手册</a>
...
<a href="../../admin-console/onboarding/customer-activation-kit.md" class="button primary">访问套件</a>
...
<a href="../../admin-console/onboarding/onboarding-workflows.md" class="button primary">访问注册流程</a>
{% endtab %}

{% tab title="团队版" %}
{% hint style="success" %}
您还可以[观看演示](admin.md#watch-a-demo-1)、参加公共[培训课程](https://bitwarden.com/events/tag/demo/)或查看有用的[入职资源](admin.md#onboarding-resources-1)。
