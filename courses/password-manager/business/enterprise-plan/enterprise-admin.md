...
作为管理员，您最大的影响来自于让 Bitwarden 易于其他人采用。本课程涵盖设置、智能策略和入职策略，这些内容都可以将密码安全变成日常习惯。
...
<summary>开始免费试用</summary>

开始免费试用，了解 Bitwarden 如何通过零知识加密和无缝部署来增强您组织的安全态势。

<a href="https://bitwarden.com/go/start-enterprise-trial/" class="button primary">开始企业版试用</a>
...
<summary>成员注册流程</summary>

本文档用于指导用户注册加入组织。有许多不同的因素会影响用户需要采取的具体步骤。使用此决策树帮助为您的组织用户选择正确的选项。

<a href="../../../../docs/admin-console/onboarding/onboarding-workflows.md" class="button primary">查看注册流程</a>
...
如果您的组织已经创建，请向您公司的 IT 团队或您的经理询问如何加入 Bitwarden 的信息。有些组织会向您的工作收件箱发送电子邮件邀请，有些组织则允许您只需使用单点登录 (SSO) 账户登录即可注册。

</details>

<details>

<summary>了解 Admin Console</summary>

创建后，您将进入 Admin Console，这是所有共享和组织管理的中心枢纽。作为组织所有者，您可以查看**密码库**项目和[集合](../../../../docs/admin-console/organizations-overview.md#collections)、管理**成员**、运行**报告**、更改**计费**设置，以及配置其他组织**设置**：
...
<summary>策略、集成及更多</summary>

Bitwarden 企业版组织提供了强大的工具，可帮助您提升在线安全，并与现有工作流程和工具集成。作为组织管理员，您还可以管理以下事项：

* 设置[策略](../../../../docs/admin-console/oversight-visibility/enterprise-policies.md)以强制执行用户安全规则，例如强制使用两步登录。
* 审计[组织成员具有访问权限](../../../../docs/password-manager/your-vault/security-tools/vault-health-reports.md#member-access)的凭据。
* 将 Bitwarden 与您现有的 [SSO](../../../../docs/admin-console/login-with-sso/about-sso.md) 流程集成。
* [验证组织域名](../../../../docs/admin-console/oversight-visibility/claimed-domains/claimed-domains.md)，以实现无缝登录体验。
* 为成员[设置](../../../../docs/admin-console/login-with-sso/trusted-devices/setup-sso-with-trusted-devices.md)设备信任要求的系统，或[批准](../../../../docs/admin-console/login-with-sso/trusted-devices/approve-a-trusted-device.md)设备信任要求
...
了解如何使用 Bitwarden 网页 App 中的 Admin Console 将密码导入您的组织。
...
## 管理用户 <a href="#managing-users" id="managing-users"></a>
...
* 直接从 Admin Console 的**成员**页面添加（[了解更多](../../../../docs/admin-console/manage-members/user-management.md#invite)）
...
<summary>受信任设备 SSO 流程</summary>

{% embed url="https://vimeo.com/1075687841?fl=pl&fe=cm" %}

了解更多当企业组织配置为[受信任设备加密的 SSO](https://help.ppgg.in/docs/admin-console/login-with-sso/trusted-devices/about-trusted-devices) 时，用户将如何体验 SSO 登录流程。
...
<summary>声明您的域名</summary>

{% embed url="https://vimeo.com/808093301?fl=pl&fe=cm" %}

通过[声明您的域名](../../../../docs/admin-console/oversight-visibility/claimed-domains/claimed-domains.md)来简化您团队的 SSO 流程。

</details>

## 策略 <a href="#policies" id="policies"></a>

<details>

<summary>数据所有权</summary>

{% embed url="https://vimeo.com/1142581672?fl=pl&fe=cm" %}

了解如何启用「强制组织数据所有权」企业策略以改进风险分析和集合管理。[了解更多](../../../../docs/admin-console/oversight-visibility/enterprise-policies.md#enforce-organization-data-ownership)。
...
{% hint style="danger" %}
目前，Bitwarden 建议仅尚未开始入职成员的组织启用[强制组织数据所有权策略](enterprise-admin.md#enforce-organization-data-ownership)。

如果您的组织在 [2025.11.0](../../../../docs/release-notes.md#id-2025.11.0) 版本之前激活了该策略，则系统会为该版本发布后确认的成员创建「**我的项目**」。现有成员不会拥有「**我的项目**」，可以继续使用他们的「**我的密码库**」。未来的版本将允许已经开始入职成员并使用个人密码库的组织将所有凭据迁移到组织所有权。
{% endhint %}
...
<summary>免费家庭版方案</summary>

免费 Bitwarden 家庭版方案默认启用，可以在您的组织设置中[禁用](../../../../docs/admin-console/oversight-visibility/enterprise-policies.md#remove-free-bitwarden-families-sponsorship)。

{% embed url="https://vimeo.com/828094070?fl=pl&fe=cm" %}

您的组织可能会提供[免费的 Bitwarden 家庭版方案](../../../../docs/admin-console/manage-members/sponsored-families/sponsored-families-for-members.md)（独立于工作账户）来保护个人密码并与最多 5 人共享，从而提供全天候安全保障。

课程也适用于[个人](../../personal/individual/individual.md)、[家庭管理员](../../personal/family-plan/family-admin.md)和[家庭成员](../../personal/family-plan/family-member.md)。
...
<summary>Access Intelligence</summary>

{% embed url="https://vimeo.com/1143606794?fl=pl&fe=cm" %}

了解 Bitwarden Access Intelligence 如何帮助您主动识别凭据风险、确定关键应用程序的优先级、指导员工更新密码以及衡量安全改进情况。[了解更多](../../../../docs/admin-console/oversight-visibility/access-intelligence.md)。
