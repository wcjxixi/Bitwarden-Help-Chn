...
### 企业演示 <a href="#enterprise-demo" id="enterprise-demo"></a>
...
### 策略、集成及更多 <a href="#managing-members-and-groups" id="managing-members-and-groups"></a>

Bitwarden 企业组织提供强大的工具，可帮助您提升在线安全，并与现有工作流程和工具集成。作为组织管理员，您还可以管理以下事项：
...
### 数据所有权 <a href="#data-ownership" id="data-ownership"></a>
...
### 免费家庭方案 <a href="#free-families-plan" id="free-families-plan"></a>

免费 Bitwarden 家庭方案默认启用，可以在您的组织设置中[禁用](../../../../docs/admin-console/oversight-visibility/enterprise-policies.md#remove-free-bitwarden-families-sponsorship)。
