...
了解 Bitwarden 在浏览器中的工作原理，从首次登录时保存密码到返回访问时自动填写凭据。下载浏览器扩展并在几分钟内完成设置。
...
<summary>加入您的组织</summary>

有几种不同的方式可以加入 Bitwarden 组织；您需要使用哪种方式取决于您的组织的独特设置。有些组织允许您使用单点登录 (SSO) 账户注册，有些组织则会向您的工作收件箱发送电子邮件邀请：

<div align="left" data-with-frame="true"><figure><img src="https://bitwarden.com/assets/4Fe96NuWb7yRe6muKf7UbZ/bcb1a8df0bc2ffdecbcd86b82d16c9a3/2025-09-03_10-41-25.png?w=800&#x26;fm=avif" alt=""><figcaption></figcaption></figure></div>
...
了解更多有关当企业组织配置为[受信任设备加密 SSO](../../../../docs/admin-console/login-with-sso/trusted-devices/setup-sso-with-trusted-devices.md) 时，用户将如何体验 SSO 登录流程。
...
<div align="left" data-with-frame="true"><figure><img src="https://bitwarden.com/assets/2xTpSA11EOCzx8VIuVffcF/d3bc18e7fc3c3cb0bf1779fad9262cd3/2024-12-02_13-42-14.png?w=800&#x26;fm=avif" alt=""><figcaption></figcaption></figure></div>
...
<summary>免费 Bitwarden 家庭版方案</summary>
...
了解从自定义文件[如何导入](../../../../docs/password-manager/import-and-export/condition-bitwarden-import.md)您的密码和其他数据。
...
{% embed url="https://vimeo.com/1153958059?fl=pl&fe=sh%E2%80%98" %}
...
作为组织的成员，您可以安全地共享登录凭据和信用卡等信息。共享的项目会归类到[集合](https://app.gitbook.com/o/o6iuhwSZ18661JC1CZl7/s/-M2XqgFI6fAcTD0lL3MZ/docs/password-manager/organization-members/sharing)中。

<div align="left" data-with-frame="true"><figure><img src="https://bitwarden.com/assets/665UWKruSMsgv2tRE8Z9Zq/3eeb08d790153cb8d1c1b70f4efd45c6/Screenshot_2025-12-13_at_1.21.45%C3%A2__AM.png?w=764&#x26;fm=avif" alt=""><figcaption></figcaption></figure></div>
