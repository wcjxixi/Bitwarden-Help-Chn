...
| 2  | 认证策略       | 确定客户是否将使用单点登录 (SSO)                                                                                                                            | [关于 SSO](../../../../docs/admin-console/login-with-sso/about-sso.md)                              | 0.25     |
...
| 步骤 | 主题     | 操作                                                                        | 资源                                                                                                                                            | 持续时间（小时） |
| -- | ------ | ------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| 12 | 组织所有者  | 识别组织所有者。所有者是能够控制组织所有方面的超级用户。决定是否希望将电子邮件与特定用户或团队收件箱关联。此外，最佳实践是为冗余设置两个所有者账户 | ​[成员角色](https://app.gitbook.com/o/o6iuhwSZ18661JC1CZl7/s/-M2XqgFI6fAcTD0lL3MZ/admin-console/manage-members/member-roles)​                     | 0.25     |
| 13 | 企业策略   | 配置企业策略。 任何策略都应在邀请用户之前启用。请务必查看以下策略：​账户恢复管理​强制执行组织数据所有权​激活自动填充              | ​[策略](https://app.gitbook.com/o/o6iuhwSZ18661JC1CZl7/s/-M2XqgFI6fAcTD0lL3MZ/admin-console/oversight-visibility/enterprise-policies)​          | 1        |
| 14 | 集合管理设置 | 选择集合在组织中的行为方式。这些设置允许从完全的管理控制到完全的自助服务（用户可以创建自己的集合）的多种选择。这些设置可用于建立最小权限策略    | ​[管理用户](https://app.gitbook.com/o/o6iuhwSZ18661JC1CZl7/s/-M2XqgFI6fAcTD0lL3MZ/admin-console/manage-members/user-management)​                  | 0.25     |
| 15 | 协同管理环境 | 向客户组织添加管理员或所有者以协同管理。最佳实践是为冗余设置两个所有者                                       | ​[管理用户](https://app.gitbook.com/o/o6iuhwSZ18661JC1CZl7/s/-M2XqgFI6fAcTD0lL3MZ/admin-console/manage-members/user-management)​                  | 0.5      |
| 16 | 创建集合   | 集合是存放安全项目并与用户群组共享的地方                                                      | ​[集合](https://app.gitbook.com/o/o6iuhwSZ18661JC1CZl7/s/-M2XqgFI6fAcTD0lL3MZ/admin-console/manage-shared-items/collections/about-collections)​ | 0.5      |
| 17 | 创建用户群组 | 创建用户群组可以轻松分配集合。如果您决定从您的身份提供程序或目录服务同步群组和用户，您可能需要稍后重新配置用户和群组分配              | ​[群组](https://app.gitbook.com/o/o6iuhwSZ18661JC1CZl7/s/-M2XqgFI6fAcTD0lL3MZ/admin-console/manage-members/groups)​                             | 0.5      |
| 18 | 集合分配   | 将群组分配给集合，确保测试并展示“只读”和“隐藏密码”选项                                             | ​[用户类型访问控制](https://app.gitbook.com/o/o6iuhwSZ18661JC1CZl7/s/-M2XqgFI6fAcTD0lL3MZ/admin-console/manage-members/member-roles)​                 | 0.5      |
| 19 | 添加项目   | 手动将项目添加到测试集合中，或通过 CSV 或 JSON 从其他密码管理应用程序导入                                | ​[集合](https://app.gitbook.com/o/o6iuhwSZ18661JC1CZl7/s/-M2XqgFI6fAcTD0lL3MZ/admin-console/manage-shared-items/collections/about-collections)​ | 0.25     |
...
| 步骤 | 主题            | 操作                                                                                          | 资源                                                                                                                                                                                                                                                                                                                                 | 持续时间（小时） |
| -- | ------------- | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| 22 | 技术节奏会议        | 与客户计划实施第 3 阶段                                                                               |                                                                                                                                                                                                                                                                                                                                    | 0.5      |
| 23 | 向集合中添加项目      | 手动将项目添加到生产集合中，或从其他密码管理应用程序导入数据                                                              | [关于集合](../../../../docs/admin-console/manage-shared-items/collections/about-collections.md)                                                                                                                                                                                                                                        | 0.25     |
...
| 25 | 强制组织数据所有权     | 要充分利用 Access Intelligence 等报告，请考虑启用组织数据所有权策略。这可确保保存到 Bitwarden 的所有项目均归该组织所有。                | [强制组织数据所有权](../../../../docs/admin-console/oversight-visibility/enterprise-policies.md#enforce-organization-data-ownership)                                                                                                                                                                                                        | 0.1      |
| 26 | 使用 SSO 登录     | 如适用，配置 Bitwarden 使用您的 SAML 2.0 或 OIDC 身份提供程序进行身份验证                                          | [关于 SSO](../../../../docs/admin-console/login-with-sso/about-sso.md)                                                                                                                                                                                                                                                               | 1.5      |
| 27 | 早期用户          | 手动将一组用户添加到客户组织中，并将他们分配到不同的群组。使用这些用户，您将在下一步广泛测试所有预配置的功能，然后再继续使用目录连接器等高级功能。将附件中的入职工作流程说明与用户分享 | <p><a href="../../../../docs/admin-console/manage-members/user-management.md#invite">管理用户 - 邀请</a></p><p></p><p><a href="../../../../docs/admin-console/onboarding/onboarding-workflows.md">入职流程</a></p>                                                                                                                           | 0.5      |
| 28 | SIEM 集成       | 如适用，将 Bitwarden 连接到客户的 SIEM 工具                                                              | [SIEM](../../../../docs/admin-console/oversight-visibility/event-logging/event-logs.md#siem-and-external-systems-integrations)                                                                                                                                                                                                     | 0.5      |
| 29 | Bitwarden 客户端 | 试点小组的所有组织成员应在各种设备上下载 Bitwarden，登录并测试通过集合访问共享项目。他们应测试策略的正确实施                                 | [下载](https://bitwarden.com/download/)                                                                                                                                                                                                                                                                                              | 0.5      |
| 30 | 部署客户端应用程序     | 配置您的应用程序管理或 MDM 工具，为批量部署 Bitwarden 应用程序做准备                                                  | [部署客户端应用程序](../../../../docs/admin-console/deploy-client-apps/deploy-browser-extensions/browserext-deploy.md)                                                                                                                                                                                                                      | 0.5      |
| 31 | 禁用内置密码管理器     | 将 Bitwarden Password Manager 设置为默认密码管理器，并关闭内置浏览器解决方案。在用户入职时教育他们如何做同样的操作                     | [禁用内置密码管理器](../../../../docs/password-manager/getting-started/getting-started-browserext.md#disable-a-built-in-password-manager)                                                                                                                                                                                                   | 0.25     |
| 32 | 测试用户入职引导      | 配置并测试 Bitwarden SCIM 或目录连接器集成，以自动同步用户和群组                                                    | <p><a href="../../../../docs/admin-console/manage-members/scim/about-scim.md">关于 SCIM</a></p><p></p><p><a href="../../../../docs/admin-console/manage-members/directory-connector/about-directory-connector.md">关于目录连接器</a></p>                                                                                                    | 1.5      |
| 33 | 用户入职引导        | 执行 SCIM 或目录连接器同步，以邀请组中的其他用户加入组织。将附件中的用户入职工作流程说明与用户分享                                        | <p>关<a href="../../../../docs/admin-console/manage-members/scim/about-scim.md">关于 SCIM</a></p><p></p><p><a href="../../../../docs/admin-console/manage-members/directory-connector/about-directory-connector.md">关于目录连接器</a></p><p></p><p><a href="../../../../docs/admin-console/onboarding/onboarding-workflows.md">入职流程</a></p> | 1        |
...
| 步骤 | 主题     | 操作                                                                                                                                                                    | 资源                                                                                                                                                                            | 时长（小时） |
| -- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| 34 | 管理员培训  | <p>为管理用户提供日常任务培训，并根据需要增加任何特殊主题<br><br>示例特殊主题包括但不限于：<br>展示配置的 SSO 登录流程<br><br>用户入职和离职<br><br>自定义角色</p>                                                                | <p><a href="../../business/enterprise-plan/enterprise-admin.md">了解管理控制台</a></p><p></p><p><a href="../../business/enterprise-plan/enterprise-admin.md">Bitwarden 企业管理员</a></p> | 0.75   |
