...
这一点非常重要，因此我们提供了一些免费选项，包括 [Bitwarden Authenticator](../../docs/bitwarden-authenticator/bitwarden-authenticator.md)（一个独立的移动验证器）。
...
[此处](../../docs/self-hosting/deploy-and-configure/docker/unified-deployment-beta.md)了解更多有关使用 Bitwarden Unified 自托管的信息。
