...
{% hint style="success" %}
对应的[官方文档地址](https://bitwarden.com/help/courses/password-manager-free-sharing-for-two/)
{% endhint %}

了解如何免费地与其他人安全地共享您的密码和登录信息 - 非常适合情侣、室友或好朋友！
...
创建后，您将进入 Admin Console，这是所有共享和组织管理的中心枢纽。作为组织所有者，您可以查看**密码库**项目和[集合](../../../../docs/admin-console/organizations-overview.md#collections)、管理**成员**、以及配置其他组织**设置**：
