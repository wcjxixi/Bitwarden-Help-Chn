...
使用两步登录（也称双重身份验证或 2FA）是除使用强大的主密码以外用来保护数据的最重要的方式。

非常重要的是我们提供了一些免费选项，包括 [Bitwarden Authenticator](../../../../docs/bitwarden-authenticator/bitwarden-authenticator.md)，一款独立的移动验证器。

### 安全准备套件 <a href="#security-readiness-kit" id="security-readiness-kit"></a>

Bitwarden [安全准备套件](https://bitwarden.com/resources/bitwarden-security-readiness-kit/)是一个可下载的清单，用于确认您的账户受到了充分保护。
