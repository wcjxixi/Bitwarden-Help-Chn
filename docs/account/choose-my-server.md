...
* 账户创建后无法变更服务器。要从 US 服务器切换到 EU 服务器（或反之），您必须在目标服务器上创建一个新的账户。创建新账户后，您可以[将现有密码库数据导出](../password-manager/import-and-export/export-vault-data.md)到新账户。
{% endhint %}
...
{% tab title="桌面 App" %}
<div data-with-frame="true"><figure><img src="https://bitwarden.com/assets/3FlU02971dqGGkp86WJJc5/e5c40a136a11ee48c5e74a068bda2405/2026-04-23_09-17-05.png?w=958&#x26;fm=avif" alt=""><figcaption><p>桌面 App 上的区域选择器</p></figcaption></figure></div>
{% endtab %}
{% endtabs %}
