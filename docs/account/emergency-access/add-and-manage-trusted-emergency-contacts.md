...
受信任的紧急联系人是指您允许其通过[紧急访问](about-emergency-access.md)登录您的 Bitwarden 账户的人员。您可以随时添加或更新受信任的紧急联系人。
...
3、输入您信任的紧急联系人的**电子邮箱**。受信任的紧急联系人必须拥有 Bitwarden 账户（免费版或高级版），以及必须位于相同的[服务器地理位置](../../security/server-geographies.md)：
...
4、为受信任的紧急联系人设置[**用户访问权限**](add-and-manage-trusted-emergency-contacts.md#user-access)级别：**查看**或**接管**。

5、设置[**等待时间**](add-and-manage-trusted-emergency-contacts.md#wait-time)。

6、选择**保存**以发送邀请。

您的受信任的紧急联系人**必须立即接受此邀请**。
...
接受邀请后，邀请的用户**必须确认您作为其受信任的联系人**，然后才能[发起访问请求](add-and-manage-trusted-emergency-contacts.md#use-emergency-access)。
...
4、要验证受邀请的用户，请与受邀请的用户确认显示的[指纹短语](../../security/encryption/account-fingerprint-phrase.md)，然后选择**确认**。

受信任的紧急联系人设置&#x20;<a href="#trusted-emergency-contact-settings" id="trusted-emergency-contact-settings"></a>
------------------------------------------------------------------------------------------------

对于每位受信任的紧急联系人，请选择自动授予访问权限前的等待时间，以及他们获得的访问权限级别。
