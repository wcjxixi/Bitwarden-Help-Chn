...
**⬇️** [下载示例](https://bitwarden.com/assets/6SVuB4OSxNq6QzGkuqGUd8/5ac1881e660cb456a60ca0da8433e814/saml-keycloak-sample.zip)
{% endhint %}
...
| Outbound Signing Algorithm          | 选择 Keycloak 客户端[被配置为用于](keycloak-saml-implementation-1.md#settings)签署 SAML 文档或断言的算法。                                                                                                                                                          |
