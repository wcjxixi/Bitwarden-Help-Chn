...
1、触发[此处](../../../account/log-in-and-unlock/more-log-in-unlock-methods/log-in-with-device.md#how-it-works)记录的流程后，客户端就获得并解密了账户加密密钥。
