...
| 访问和管理组织内的所有集合                                                                                                                             | **✘** 如果关闭了**允许所有者和管理员从 Admin Console 管理所有集合和项目**[设置](../manage-shared-items/collections/collection-settings.md#allow-owners-and-admins-to-manage-all-collections-and-items-from-the-admin-console) | **✘** 如果关闭了**允许所有者和管理员从 Admin Console 管理所有集合和项目**[设置](../manage-shared-items/collections/collection-settings.md#allow-owners-and-admins-to-manage-all-collections-and-items-from-the-admin-console) | **✘**                                                                                                                                                                                                                             |
