...
| 编辑已分配的集合中的隐藏字段                                                                                                                             | **✘**  | **✘**     | **✔︎**                                                                                                                                     | **✘**                                                                                                                                       | **✔︎**                                                                                                                                |
| 从已分配的集合中移除项目                                                                                                                               | **✘**  | **✘**     | **✔︎**                                                                                                                                     | **✘**                                                                                                                                       | **✔︎**                                                                                                                                |
| 从已分配的集合中删除项目                                                                                                                               | **✘**  | **✘**     | **✔︎** 如果关闭**限制为具有「管理集合」权限的成员可以删除项目**[设置](collection-settings.md#restrict-item-deletion-to-members-with-the-manage-collection-permissions) | **✔︎** 如果关闭了**限制为具有「管理集合」权限的成员可以删除项目**[设置](collection-settings.md#restrict-item-deletion-to-members-with-the-manage-collection-permissions) | **✔︎**                                                                                                                                |
