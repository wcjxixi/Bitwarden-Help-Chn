...
* [生成强密码](../../password-manager/getting-started/getting-started-browserext.md#generate-a-strong-password)
...
* [集合访问权限管理](../more/teams-and-enterprise-migration-guide.md#step-5-configure-access-to-collections-and-items)
