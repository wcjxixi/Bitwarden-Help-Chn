...
{% tab title="3" %}
您的 Bitwarden 账户的电子邮箱地址必须与您用于登录 \[IdP，例如 JumpCloud] 的地址匹配。如果不匹配，请[更改您的电子邮箱地址](../../password-manager/more/password-manager-faqs.md#q-how-do-i-change-my-email-address)，然后完成以下步骤以加入我们的组织：
