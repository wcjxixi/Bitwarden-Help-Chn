...
组织将 Bitwarden 用户和密码库项目联系在一起，以[安全地共享](../password-manager/organization-members/sharing.md)登录、笔记、支付卡和身份信息。组织有一个独立的视图，即管理员控制台，[管理员](manage-members/member-roles.md)可在此管理组织的项目和成员、运行报告以及配置组织设置等：
...
创建您的组织后，就可以创建[集合](manage-shared-items/collections/about-collections.md)、[邀请用户](manage-members/user-management.md)并[开始共享](../password-manager/organization-members/sharing.md)。
