...
企业组织可以使用 **Access Intelligence** 来识别并优先处理由其成员存储在 Bitwarden 组织内的、[存在风险](access-intelligence.md#determining-risk)凭据的应用程序。通过此报告，您可以选择[关键应用程序](access-intelligence.md#marking-critical-applications)，并通知组织成员需要[对存在风险的密码采取措施](../../password-manager/organization-members/change-at-risk-passwords.md)。
...
* **密码更改进度**：[已发送的密码更改请求](access-intelligence.md#requesting-password-changes)的完成百分比。
...
请求密码修改将会向有权访问关键应用程序的组织成员发送通知，告知他们需要[处理存在风险的密码](../../password-manager/your-vault/security-tools/change-at-risk-passwords.md)。成员将通过电子邮件收件箱和已登录的 Bitwarden 浏览器扩展中的横幅接收通知。
