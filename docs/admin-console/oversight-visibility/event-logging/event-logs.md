...
使用事件日志（带有时间戳的记录，用于捕获整个团队或企业组织层面中各类变更和使用情况）可以跟踪您组织的活动并溯源安全事件。您可以通过[网页 App](event-logs.md#access-event-logs) 以及 [Bitwarden 公共 API](event-logs.md#api-responses) 的 `/events` 端点访问这些日志。虽然事件日志数据会无限期保留，您一次最多只能查看 367 天的数据。

## 访问事件日志 <a href="#access-event-logs" id="access-event-logs"></a>

要在 Bitwarden 网页 App 中查看事件日志：

1、从产品切换器打开 Admin Console：
...
<div align="left" data-with-frame="true"><figure><img src="https://bitwarden.com/assets/011fNmRs4fFzD5RjtL7bVT/bda04d6785c1749e0e85d9ee3d60872e/Event_identifier.png?w=1175&#x26;fm=avif" alt=""><figcaption><p>事件标识符</p></figcaption></figure></div>
...
* 事件的**时间戳**
* **客户端**应用程序的类型和 IP 地址（通过悬停在**客户端**列的值或客户端图标上以获取详细信息）
* 连接到事件的**成员**
* **事件**的描述

事件与类型代码（`1000`、`1001` 等）关联，以标识事件所捕获的操作。[Bitwarden 公共 API](../../bitwarden-public-api.md) 使用类型代码来标识被事件所记录的操作。
...
* 查看了项目 `item-identifier` 的安全码。(`1118`)
...
* 自动确认了用户 `user-identifier`。(`1517`)
* 用户 `user-identifier` 从组织中自行撤销。(`1518`)
* 编辑了组织设置。(`1600`)
* 清除了组织密码库。(`1601`)
* 导出了组织密码库。(`1602`)
...
* 家庭赞助同步完成。(`1608`)
* 修改了集合管理设置。(`1609`)
* 启用了[限制集合创建](../../manage-shared-items/collections/collection-settings.md#restrict-collection-creation-to-owners-and-admins)设置。 (`1610`)
* 停用了[限制集合创建](../../manage-shared-items/collections/collection-settings.md#restrict-collection-creation-to-owners-and-admins)设置。(`1611`)
* 启用了[限制集合删除](../../manage-shared-items/collections/collection-settings.md#restrict-collection-deletion-to-owners-and-admins)设置。(`1612`)
* 停用了[限制集合删除](../../manage-shared-items/collections/collection-settings.md#restrict-collection-deletion-to-owners-and-admins)设置。(`1613`)
* 启用了[限制项目删除](../../manage-shared-items/collections/collection-settings.md#restrict-item-deletion-to-members-with-the-manage-collection-permissions)设置。(`1614`)
* 停用了[限制项目删除](../../manage-shared-items/collections/collection-settings.md#restrict-item-deletion-to-members-with-the-manage-collection-permissions)设置。(`1615`)
* 启用了[允许所有者和管理员管理所有集合和项目](../../manage-shared-items/collections/collection-settings.md#allow-owners-and-admins-to-manage-all-collections-and-items-from-the-admin-console)设置。(`1616`)
* 停用了[允许所有者和管理员管理所有集合和项目](../../manage-shared-items/collections/collection-settings.md#allow-owners-and-admins-to-manage-all-collections-and-items-from-the-admin-console)设置。(`1617`)
* 接受了转移到组织所有权。(`1618`)
* 因拒绝转移到组织所有权而被撤销。(`1619`)
* 启用了自动用户确认设置。(`1620`)
* 停用了自动用户确认设置。(`1621`)
* 添加了自动用户确认策略。(`1622`)
* 移除了自动用户确认策略。(`1623`)
...
<div align="left" data-with-frame="true"><figure><img src="https://bitwarden.com/assets/4e95ZWDt6ZBPfina42MZhP/d4653c6aebb2bcff6186e6d49415da61/2024-12-05_09-47-18.png?w=1031&#x26;fm=avif" alt=""><figcaption><p>提供商访问事件</p></figcaption></figure></div>

## 导出事件 <a href="#export-events" id="export-events"></a>

要导出指定日期范围内所有事件的 `.csv` 文件，请选择**导出**：

<div align="left" data-with-frame="true"><figure><img src="https://bitwarden.com/assets/QL3nTOsAOsCPQtQTONOEw/53652d49e4bf8eaa67c972c1b55c12fc/2024-12-04_09-48-02.png?w=1175&#x26;fm=avif" alt=""><figcaption><p>导出事件日志</p></figcaption></figure></div>
...
从 [Bitwarden 公共 API](../../bitwarden-public-api.md) 的 `/events` 端点访问事件日志将返回 JSON 响应，例如：
