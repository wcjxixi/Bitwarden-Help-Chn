...
1. 打开您的 iOS 设备上的 <i class="fa-gear-complex">:gear-complex:</i>**设置** App。
2. 点击**通用**。
3. 点击**键盘**。
...
1. **如果您已激活了** [**PIN 码**](../../account/log-in-and-unlock/more-log-in-unlock-methods/unlock-with-pin.md)**验证**，禁用它。
...
5. 如果要将 PIN 码验证用作[生物识别](../../account/log-in-and-unlock/more-log-in-unlock-methods/unlocking-with-biometrics.md)的备份，请重新启用 [PIN 码](../../account/log-in-and-unlock/more-log-in-unlock-methods/unlock-with-pin.md)验证。
