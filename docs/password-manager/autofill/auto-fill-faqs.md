...
1. **如果您已激活了** [**PIN 码**](../../account/log-in-and-unlock/more-log-in-unlock-options/unlock-with-pin.md)**验证**，禁用它。
...
5. 如果要将 PIN 码验证用作[生物识别](../../account/log-in-and-unlock/more-log-in-unlock-options/unlocking-with-biometrics.md)的备份，请重新启用 [PIN 码](../../account/log-in-and-unlock/more-log-in-unlock-options/unlock-with-pin.md)验证。
