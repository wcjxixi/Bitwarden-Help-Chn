...
从 CLI 访问组织经常需要知道组织的 ID 以及单个[成员](../../../admin-console/manage-members/user-management.md)的 ID 和[集合](../../../admin-console/manage-shared-items/collections/about-collections.md)的 ID。
