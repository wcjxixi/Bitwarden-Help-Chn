...
* 将[文件附件](../../your-vault/vault-items/file-attachments.md)逐个上传到新密码库。
...
对于大多数设备，打开移动浏览器，登录 Bitwarden，然后按照[网页 App 的导入步骤](import-data-from-chrome.md#wang-ye-app)操作。

### 使用凭据交换协 <a href="#direct-import-with-the-cxp" id="direct-import-with-the-cxp"></a>
...
### &#x20;<a href="#direct-import-with-the-cxp" id="direct-import-with-the-cxp"></a>
{% endtab %}
