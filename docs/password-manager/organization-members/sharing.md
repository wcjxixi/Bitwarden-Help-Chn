...
共享需要[组织](../../admin-console/organizations-overview.md)的成员资格。使用 Bitwarden，共享项目意味着两件事：
...
使用 Bitwarden 共享项目有许多不同的方法。在本文中，我们将介绍这些方法。无论哪种方法最适合您的工作流程，请记住，您需要成为组织的成员才能共享。
