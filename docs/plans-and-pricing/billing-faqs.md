...
* 对于个人订阅：请导航至**设置** → **订阅**。如果找不到此界面，则表示此账户是免费方案。如果存在此界面，则表示此账户是高级方案。
* 对于组织订阅：打开 Admin Console，导航至组织的**计费** → **订阅**视图。**方案**部分将显示该组织的方案信息。

### 问：如何查看我的计费信息？ <a href="#q-how-do-i-view-my-billing-information" id="q-how-do-i-view-my-billing-information"></a>

**答：**&#x67E5;看计费信息取决于您是查看个人订阅还是组织订阅的计费信息。请使用[更新您的计费信息](update-your-billing-information.md)来指导您完成这两个过程。

### 问：如何删除我的账户？ <a href="#q-how-do-i-delete-my-account" id="q-how-do-i-delete-my-account"></a>

**答：**&#x6211;们很遗憾看到您离开。请使用[删除您的账户](delete-an-account-or-organization.md)来指导您完成这个过程。
...
**答：**&#x8BF7;使用[从个人升级到组织](password-manager/upgrade-from-individual-to-organization.md)来指导您完成这个过程。
...
**答：**&#x5BF9;于团队版和企业版组织，当您邀请新用户时，将自动添加用户席位。您可以[指定限制](../admin-console/manage-members/user-management.md#set-a-seat-limit)以防止您的席位数超过指定的数量。
...
**答：**&#x5F53;前的家庭版方案（2020 年 09 月推出）自动为组织的所有 6 位成员提供高级功能，所以不需要！

传统的家庭版方案不会自动提供高级版功能，因此用户需要单独升级到高级版，或者由家庭版组织的所有者升级组织。

### 问：为什么我的云端和自托管许可证到期日期不一致？

**答：**&#x4E3A;了确保您不会意外丢失组织功能，我们在云端许可证到期和自托管服务器上许可证到期之间提供 2 个月的宽限期。[了解更多](organization-renewal.md)。
...
**答：**&#x6211;们接受信用卡/借记卡、PayPal、银行账户 (ACH)，以及比特币。对于企业版订阅，我们还接受电汇和企业支票，最低付款额为 500 美元。有关付款方式的更多信息，请[联系支持](https://bitwarden.com/contact/)。
...
**答：**&#x6211;们接受信用卡/借记卡、PayPal，以及比特币。对于企业版订阅，我们还接受电汇和企业支票，最低付款额为 500 美元。有关付款方式的更多信息，请[联系支持](https://bitwarden.com/contact/)。
...
**答：**&#x53EA;要遵守我们的[服务条款](https://bitwarden.com/terms/)，用户可以使用 Bitwarden 客户端（无论是付费账户还是免费账户）用于个人或商业用途。
...
**答：**&#x6211;们观察到一部分 Firefox 用户在提交高级版订阅的付款信息时会收到如下错误信息：
