...
开始一个免费版组织来与另一个用户存储并安全地共享数据。免费版组织为 2 个用户提供 Password Manager 的所有核心功能，并可在最多两个集合中安全共享数据。任何方案的任何用户都可以是一个免费版组织的所有者。

### 家庭版组织 <a href="#families-organizations" id="families-organizations"></a>

开始一个家庭版组织，以在您和您的 5 个朋友或家庭成员之间共享私人数据。家庭版组织包含所有 6 个用户的所有高级功能以及家庭版组织内无限制的安全数据共享。
...
| \*[两步登录](../../account/two-step-login/setup-two-step-login/two-step-login-methods.md) | 硬件安全密钥、验证器 App、电子邮箱 | 硬件安全密钥、验证器 App、电子邮箱、Yubikey、FIOD2 以及 Duo | 硬件安全密钥、验证器 App、电子邮箱 | 验硬件安全密钥、验证器 App、电子邮箱、Yubikey、FIOD2 以及 Duo（不包括[用于组织的 Duo](../../account/two-step-login/setup-two-step-login/two-step-login-via-duo.md)） |
| \*[加密文件附件](../../password-manager/your-vault/vault-items/file-attachments.md)         | —                   | 5GB                                      | —                   | 5GB/用户 + 5GB 共享                                                                                                                        |
...
| \*[紧急访问](../../account/log-in-and-unlock/more-log-in-options/emergency-access.md)     | —                   | **✔︎**                                   | —                   | **✔︎**                                                                                                                                 |
| [Secrets Manager ](../../secrets-manager/secrets-manager-overview.md)附加组件资格           | —                   | —                                        | **✔︎**              | —                                                                                                                                      |
| \*优先支持                                                                                | —                   | **✔︎**                                   | —                   | **✔︎**                                                                                                                                 |
| 费用                                                                                    | 免费                  | $1.65/月（按年计费）                            | 免费                  | $3.99/月（按年计费）                                                                                                                          |
...
| \*[加密文件附件](../../password-manager/your-vault/vault-items/file-attachments.md)                         | 5GB/用户 + 5GB 共享                    | 5GB/用户 + 5GB 共享                   |
