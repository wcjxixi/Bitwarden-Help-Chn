...
| \*[加密文件附件](../../password-manager/your-vault/vault-items/file-attachments.md)         | —                   | 1 GB                                     | —                   | 1 GB/用户 + 1 GB 共享                                                                                                                      |
| \*[集成的验证器](../../password-manager/your-vault/security-tools/totp.md) (TOTP)           | —                   | **✔︎**                                   | （如果也是高级个人）          | **✔︎**                                                                                                                                 |
...
| [适用于组织的 Duo](../../admin-console/login-with-sso/implementation-guides/duo-saml-implementation.md) | **✔︎**                             | **✔︎**                            |
...
| [适用于成员的家庭赞助](families-for-enterprise.md)                                                          | —                                  | **✔︎**                            |
