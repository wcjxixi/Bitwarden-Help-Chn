...
2. 在**用户席位**字段中，指定要为 Secrets Manager 购买的席位数量。该数字必须小于或等于您的 Password Manager 订阅的席位数。
3. 在**附加机器账户**字段中，指定要添加到 Secrets Manager 的服务机器数量。团队方案和企业方案分别预先提供了 50 个和 200 个机器账户。
{% endhint %}
...
* [共享项目到集合](../../password-manager/organization-members/sharing.md)
