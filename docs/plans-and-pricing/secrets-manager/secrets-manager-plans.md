...
这篇文章中，我们将阐述 [Bitwarden Secrets Manager](../../secrets-manager/secrets-manager-overview.md) 的每一种订阅方案，以帮助您开启机密管理和安全数据存储之旅。要查看 Password Manager 方案，请参阅[此处](../password-manager/about-bitwarden-plans.md)。
