...
要开始 Secrets Manager 订阅，请[创建一个包含 Secrets Manager 的新组织](../../admin-console/organizations-overview.md#create-an-organization)或升级现有组织。
...
{% tabs %}
{% tab title="免费版" %}
如果您使用的是免费版组织，则可以免费使用 Secrets Manager 与另一位用户共享[机密](../../secrets-manager/your-secrets/secrets.md)，或升级到付费方案以解锁更多功能。要将 Secrets Manager 添加到您的免费版​​组织：
