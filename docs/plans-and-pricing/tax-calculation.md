...
* 对于组织，从 Admin Console 的**计费** → **订阅**菜单。
...
对于个人订阅，包括[个人高级版订阅](password-manager/about-bitwarden-plans.md#premium-individual)和[家庭版组织订阅](password-manager/about-bitwarden-plans.md#families-organizations)，增值税 (VAT) 将计算并作为单独的项目列在您的账单中。
...
1、在网页 App Admin Console 中，前往**计费** → **付款详细信息**。
