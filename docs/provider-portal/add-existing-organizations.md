...
当 Bitwarden 检测到[提供商管理员](provider-users.md#provider-user-types)的账户是**非提供商组织的所有者**时，提供商门户将显示 <i class="fa-plus">:plus:</i>**添加现有组织**按钮：
...
选择 <i class="fa-plus">:plus:</i>**添加现有组织**按钮将提示您选择此组织以添加到提供商：
...
1. 组织不能没有所有者，因此请向组织[添加一位备用所有者](../admin-console/manage-members/user-management.md#invite)。
2. 新的所有者被邀请、接受并确认后，请告诉他们[将您从组织中移除](../admin-console/manage-members/user-management.md#offboard-users)。
{% endhint %}
