...
_（所列版本号为 Bitwarden 服务器的版本号，在此周期中发布的其他版本号还包括 Web 2026.6.2、浏览器扩展 2026.6.0、桌面端 2026.6.0、移动端 2026.6.1、CLI 2026.6.0）_

### Password Manager

* **★浏览器扩展的填充辅助**：激活[填充辅助](password-manager/autofill/more-autofill-options/fill-assist.md)功能，可在 Bitwarden 整理的、已知会经常导致自动填充问题的网站上提高自动填充的准确性。
...
* **★现在将对已接受的成员强制实施组织策略**：用户接受组织邀请后，所有已配置的组织策略即适用于其账户。

## 2026.6.0

_（所列版本号为 Bitwarden 服务器的版本号，在此周期中发布的其他版本号还包括 Directory Connector 2026.6.0、Web 2026.6.0、移动端 2026.6.0）_
