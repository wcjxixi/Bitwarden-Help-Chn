...
* **★Blumira SIEM 集成**：团队版和企业版组织现在可以与 [Blumira 集成](admin-console/oversight-visibility/siem-integrations/blumira-siem.md)，以实现安全和事件管理 (SIEM)。
...
* **Huntress SIEM 集成**：Bitwarden 团队版和企业版组织现在可以[与 Huntress 集成](admin-console/oversight-visibility/siem-integrations/huntress-siem.md)以用于安全信息和事件管理 (SIEM)。
