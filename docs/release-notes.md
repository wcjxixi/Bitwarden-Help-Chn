...
* **★在扩展和桌面端更改主密码**：您现在可以在浏览器扩展和桌面 App 中[更改您的主密码](account/log-in-and-unlock/your-master-password.md#change-your-master-password)。为了支持未来的改进，此前允许通过命令行界面 (CLI) 更改主密码的工作流已被移除。
