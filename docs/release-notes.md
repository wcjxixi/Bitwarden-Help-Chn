...
* **桌面端主密码重新提示更新**：当某个项目的主密码重新提示选项处于活动状态时，桌面 App 现在将控制成功验证后的所有字段，而不仅仅是隐藏字段。[了解更多](password-manager/your-vault/vault-items/vault-items.md#protect-individual-items)。
...
* **主密码重新提示**：使用新的主密码重新提示选项，要求验证您的主密码才能查看被用户指定的敏感密码库项目。（参阅[这里](password-manager/your-vault/vault-items/vault-items.md#protect-individual-items)）。
