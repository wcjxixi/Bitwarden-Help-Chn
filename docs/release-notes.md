...
（所列版本号为 Bitwarden 服务器的版本号，在此周期中发布的其他版本号还包括 Web 2026.5.0、浏览器扩展 2026.5.0、桌面端 2026.5.0、移动端 2026.5.0、CLI 2026.5.0）
...
* **Flatpak 和 Snap 现已支持生物识别集成**：通过与 Bitwarden 桌面 App 的集成使用，Flatpak 和 Snap 发行版现已支持[浏览器扩展的生物识别解锁](account/log-in-and-unlock/more-unlock-options/unlocking-with-biometrics.md)。
...
（所列版本号为 Bitwarden 服务器的版本号，在此周期中发布的其他版本号还包括 Web 2026.4.2、浏览器扩展 2026.4.0、桌面端 2026.4.0、移动端 2026.4.1、CLI 2026.4.0）
...
（所列版本号为 Bitwarden 服务器的版本号，在此周期中发布的其他版本号还包括 Web 2026.4.0、移动端 2026.4.0）
...
（所列版本号为 Bitwarden 服务器的版本号，在此周期中发布的其他版本号还包括 Web 2026.3.1、浏览器扩展 2026.3.0、移动端 2026.3.1、桌面端 2026.3.1、CLI 2026.3.0）
...
（所列版本号为 Bitwarden 服务器的版本号，在此周期中发布的其他版本号还包括 Web 2026.3.0、浏览器扩展 2026.3.0、移动端 2026.3.0）
...
（所列版本号为 Bitwarden 服务器的版本号，在此周期中发布的其他版本号还包括 Web 2026.2.1、浏览器扩展 2026.2.0、移动端 2026.2.1、桌面端 2026.2.1、CLI 2026.2.0）
...
（所列版本号为 Bitwarden 服务器的版本号，在此周期中发布的其他版本号还包括 Web 2026.2.0、浏览器扩展 2026.1.1、移动端 2026.2.0）
