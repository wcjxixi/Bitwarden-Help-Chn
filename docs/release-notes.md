...
{% hint style="info" %}
**安全提示**：为修复 [Bitwarden CLI](password-manager/developer-tools/cli/password-manager-cli.md) 本地存储 API 密钥的漏洞，本版本之后的**下一个 Bitwarden 服务器版本**将自动轮换 Bitwarden CLI 用户的[个人 API 密钥](password-manager/developer-tools/cli/personal-api-key.md)。如果您在任何自动化工作流中使用了 Bitwarden CLI，请在该版本发布后立即使用新的 API 密钥更新这些工作流，以确保服务连续性。
{% endhint %}
...
* **优化的批量重新邀请**：管理控制台批量重新发送组织邀请的功能已从之前的每次操作限制为 500 个邀请，现在支持每次操作最多 8,000 个邀请。
