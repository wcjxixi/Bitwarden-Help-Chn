...
团队和企业组织也可以使用 [Bitwarden 公共 API ](../admin-console/bitwarden-public-api.md)为其事件日志收集更多数据。
...
| 发布日期             | 变更摘要                      |
| ---------------- | ------------------------- |
| 2025 年 10 月 09 日 | 添加了关源代码扫描的信息。             |
| 2025 年 06 月 30 日 | 添加了关于加密过程的各种说明。           |
| 2025 年 05 月 21 日 | 更正了有关我们禁止禁用用户 2FA 的政策的声明。 |
