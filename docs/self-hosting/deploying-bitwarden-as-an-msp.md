...
Bitwarden 组织将用户和密码库项目联系在一起，以便[安全地共享](../password-manager/organization-members/sharing.md)登录、笔记、支付卡和身份信息。组织可以是一个家庭、团队、公司或任何需要安全地共享数据的人群。组织有一个独立的密码库，[管理员](../admin-console/manage-members/member-roles.md)可以在那里管理组织的项目、用户和设置。

<div align="left" data-with-frame="true"><figure><img src="https://raw.githubusercontent.com/bitwarden/help/25bc445da1a9484e93ae6759ea2ef391d0c1881a/images/organizations/org-vault-admin.png" alt=""><figcaption><p>组织密码库</p></figcaption></figure></div>

MSP 应该为每一个客户[创建一个组织](../admin-console/organizations-overview.md#create-an-organization)，或者客户可以为自己创建一个。你可以在好几种[组织类型](../admin-console/organizations-overview.md#types-of-organizations-1)中你选择一种最适合您的客户的需要的类型。对于最强大的业务功能集，我们推荐[企业方案](../plans-and-pricing/password-manager/about-bitwarden-plans.md#enterprise-organizations)。
...
集合汇集了用于在一个组织内[安全共享](../password-manager/organization-members/sharing.md)的登录、笔记、支付卡和身份信息。构建可扩展集合的常见方式包括：**按部门集合**（比如来自营销团队的用户被分配到 **Marketing** 集合），或**按功能集合**（比如营销团队的用户被分配到 **Social Media** 集合）：

<div align="left" data-with-frame="true"><figure><img src="https://raw.githubusercontent.com/bitwarden/help/25bc445da1a9484e93ae6759ea2ef391d0c1881a/images/organizations/collections-graphic-1.png" alt=""><figcaption><p>集合</p></figcaption></figure></div>
...
<div align="left" data-with-frame="true"><figure><img src="https://raw.githubusercontent.com/bitwarden/help/25bc445da1a9484e93ae6759ea2ef391d0c1881a/images/organizations/collections-graphic-2.png" alt=""><figcaption><p>群组</p></figcaption></figure></div>

[了解如何创建群组](../admin-console/manage-members/groups.md#create-a-group)
...
MSP 团队可以手动管理组织的用户，或使用 Directory Connector 从现有目录服务（LDAP、AD 等）同步用户和群组。对于大多数 MSP 客户来说，Directory Connector 是推荐的方式：

<div align="left" data-with-frame="true"><figure><img src="https://raw.githubusercontent.com/bitwarden/help/25bc445da1a9484e93ae6759ea2ef391d0c1881a/images/directory-connector/dc-diagram.png" alt=""><figcaption><p>Directory Connector</p></figcaption></figure></div>
...
* [使用 Directory Connector](../admin-console/manage-members/directory-connector/about-directory-connector.md)
