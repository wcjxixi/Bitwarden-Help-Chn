...
1、**（仅企业版组织）**&#x91CD;新实施您的[企业策略](../../admin-console/oversight-visibility/enterprise-policies.md)规范和/或配置 [SSO 登录](../../admin-console/login-with-sso/about-sso.md)。
...
7、如果您在**步骤 2** 中指定了一个不同的服务器域名，请编辑以下内容：
