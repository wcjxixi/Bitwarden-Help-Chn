...
如果您是使用[禁用个人密码库策略](../organizations/enterprise-policies.md#remove-individual-vault)的组织的成员，选择**保存**将带您进入一个屏幕，您可以在其中选择要将其添加到的[集合](../admin-console/organization-basics/about-collections.md)。
