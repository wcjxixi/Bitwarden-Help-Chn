...
说到[集合](../../organizations/collections.md)，它们是一种重要的结构，用于将相关的登录、备注、支付卡和身份组合在一起，以便与组织安全地共享：
...
* [验证您的组织的域名](../../admin-console/login-with-sso/domain-verification.md)，实现无缝登录体验。
...
* 帮助家人设置[两步登录](../../two-step-login/two-step-login-methods.md)，以保护他们的 Bitwarden 账户。
* 帮助家人设置[紧急访问](../../security/emergency-access.md)，以便在紧急情况下访问重要数据。
{% endtab %}
