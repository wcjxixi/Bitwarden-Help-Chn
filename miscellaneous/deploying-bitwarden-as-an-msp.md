...
MSP 应该为每一个客户[创建一个组织](../organizations/organizations.md#create-an-organization)，或者客户可以为自己创建一个。你可以在好几种[组织类型](../organizations/organizations.md#types-of-organizations-1)中你选择一种最适合你的客户的需要的类型。对于最强大的业务功能集，我们推荐[企业计划](../plans-and-pricing/about-bitwarden-plans.md#enterprise-organizations)。
