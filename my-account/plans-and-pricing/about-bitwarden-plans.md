...
| \*[加密文件附件](../../password-manager/vault-basics/file-attachments.md)              | —          | 1 GB                            | —          | 1 GB/用户 + 1 GB 共享                                                                                         |
| \*[Bitwarden 验证器](../../password-manager/vault-basics/totp.md) (TOTP)            | —          | **✔︎**                          | —          | **✔︎**                                                                                                    |
| \*[密码库健康报告](../../password-manager/vault-administration/vault-health-reports.md) | —          | **✔︎**                          | —          | **✔︎**                                                                                                    |
| \*[紧急访问](../more/emergency-access.md)                                            | —          | **✔︎**                          | —          | **✔︎**                                                                                                    |
| \*优先支持                                                                           | —          | **✔︎**                          | —          | **✔︎**                                                                                                    |
...
| 适用于组织的 Duo                                                                                    | **✔︎**                          | **✔︎**                          |
| \*[加密文件附件](../../password-manager/vault-basics/file-attachments.md)                           | 1 GB/用户 + 1 GB 共享               | 1 GB/用户 + 1 GB 共享               |
| \*[Bitwarden 验证器](../../password-manager/vault-basics/totp.md)(TOTP)                          | **✔︎**                          | **✔︎**                          |
| \*[个人紧急访问](../more/emergency-access.md)                                                       | **✔︎**                          | **✔︎**                          |
| \*[密码库健康报告](../../password-manager/vault-administration/vault-health-reports.md)              | **✔︎**                          | **✔︎**                          |
| \*优先支持                                                                                        | **✔︎**                          | **✔︎**                          |
| [事件日志](../../admin-console/organization-basics/event-logs.md)                                 | **✔︎**                          | **✔︎**                          |
| [用户群组](../../admin-console/organization-basics/groups.md)                                     | **✔︎**                          | **✔︎**                          |
| [API 访问](../../admin-console/bitwarden-public-api.md)                                         | **✔︎**                          | **✔︎**                          |
| [目录连接器](../../admin-console/user-management/directory-connector/about-directory-connector.md) | **✔︎**                          | **✔︎**                          |
| [SSO 登录](../../admin-console/login-with-sso/about-login-with-sso.md)                          | —                               | **✔︎**                          |
| [Key Connector](../../admin-console/login-with-sso/key-connector/about-key-connector.md)      | —                               | **✔︎**                          |
| [企业策略](../../admin-console/organization-basics/enterprise-policies.md)                        | —                               | **✔︎**                          |
| [管理员密码重置](../../admin-console/user-management/admin-password-reset.md)                        | —                               | **✔︎**                          |
| [自托管选项](../../on-premises-hosting/)                                                           | —                               | **✔︎**                          |
| [自定义管理角色](../../admin-console/user-management/user-types-and-access-control.md)               | —                               | **✔**                           |
