...
**答：**对于团队和企业组织，当您邀请新用户时，将自动添加用户席位。您可以[指定限制](../../admin-console/user-management/user-management.md#set-a-seat-limit)以防止您的席位数超过指定的数量。

要移除用户席位，请导航到您组织的**设置** → **订阅**界面，然后使用订阅席位输入框来移除席位（[了解更多](../../admin-console/user-management/user-management.md#manually-add-or-remove-seats)）。
...
如需了解更多信息，请参阅[本地托管](../../on-premises-hosting/licensing-for-paid-features.md#organization-license)。
