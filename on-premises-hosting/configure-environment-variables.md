...
| globalSettings\_\_sso\_\_enforceSsoPolicyForAllUsers= | 指定 `true` 以对所有者和管理员角色强制执行[需要 SSO 身份验证](../organizations/enterprise-policies.md#require-single-sign-on-authentication)策略。                                                                                                                                                                   |
