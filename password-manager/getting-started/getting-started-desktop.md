...
Bitwarden 的桌面应用程序将完整的密码库体验从浏览器直接带入您的桌面。桌面应用程序一次支持最多 5 个已登录的帐户，可以随时在个人帐户和工作帐户之间轻松切换（[了解更多](../../my-account/log-in-and-unlock/account-switching.md)）。
...
桌面应用程序最受欢迎的设置之一是[使用生物识别解锁](../../my-account/log-in-and-unlock/unlocking-with-biometrics.md)，它允许使用**触控 ID** 技术无缝访问您的桌面应用程序。要设置生物识别解锁：
