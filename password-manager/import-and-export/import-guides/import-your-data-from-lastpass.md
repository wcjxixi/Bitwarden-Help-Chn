...
当将 Lastpass 的 `.csv` 导出文件导入到[免费组织](../../../my-account/plans-and-pricing/about-bitwarden-plans.md)时，您可能会看到如下错误：
...
当 Lastpass 导出包含 3 个或更多 `grouping` 值时，就会发生该错误。`grouping` 字段中的值被 Bitwarden 解释为[集合](../../../admin-console/organization-basics/collections.md)，但[免费组织](../../../my-account/plans-and-pricing/about-bitwarden-plans.md)限制为仅两个集合。例如，下面的 `.csv` 将导致该错误：
