...
| \*[两步登录](../../account/two-step-login/setup-guides/two-step-login-methods.md)         | 硬件安全密钥、验证器 App、电子邮箱 | 硬件安全密钥、验证器 App、电子邮箱、Yubikey、FIOD2 以及 Duo | 硬件安全密钥、验证器 App、电子邮箱 | 验硬件安全密钥、验证器 App、电子邮箱、Yubikey、FIOD2 以及 Duo（不包括[用于组织的 Duo](../../account/two-step-login/setup-guides/two-step-login-via-duo.md)） |
