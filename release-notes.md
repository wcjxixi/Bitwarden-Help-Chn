...
{% hint style="danger" %}
仅限自托管：Bitwarden 自托管 2025.6.0-2025.6.2 版本在无意中移除了某些部署模式下对 **Kerberos** 外部数据库身份验证的支持。这将在即将发布的自托管版本中得到修复，除非 Bitwarden 支持另有说明，否则使用 Kerberos 身份验证的客户应等到下一个版本发布后再升级他们的自托管部署。
{% endhint %}
