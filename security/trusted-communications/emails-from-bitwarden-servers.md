...
| 主题                                  | 变量                        | 描述                                                                                                                                                                              |
| ----------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 加入 {Organization}                   | {Organization} = 您组织的显示名称 | 当某个用户被邀请加入组织时，他们会收到此电子邮件。                                                                                                                                                       |
| 您已被从 {Organization} 中移除             | {Organization} = 您组织的显示名称 | 当用户因违反[要求两步登录](../../organizations/enterprise-policies.md#require-two-step-login)或[单一组织](../../organizations/enterprise-policies.md#single-organization)策略而被撤销访问权限时，他们会收到此电子邮件。 |
| 您的管理员已启动账户恢复                        | n/a                       | 当管理员[对其账户启动了账户恢复](../../organizations/admin-password-reset.md#recover-an-account)时，用户会收到此电子邮件。                                                                                  |
...
| 成功！已接受家庭订阅             | n/a                       | 其已兑换创建赞助的家庭组织的邀请时，用户会收到此电子邮件。                 |
| 您的家庭赞助已被移除             | n/a                       | 其已手动移除家庭组织的赞助时，用户会收到此电子邮件。                    |
...
| 更新您的计费信息                        | n/a                                  | 如果客户组织的所有者收到此邮件，则表示他们的组织已被从提供者管理中移除，并且必须添加方式。 |
| 请求删除您的提供商                       | n/a                                  | 如果所有者向 Bitwarden 支持团队请求删除其组织，则会收到此邮件。         |
...
| 主题          | 变量  | 描述                                           |
| ----------- | --- | -------------------------------------------- |
| 许可证过期       | n/a | 当所有者自托管服务器的许可证文件在过期后超过了 60 天的宽限期时，他们会收到这封邮件。 |
| \[管理员] 继续登录 | n/a | 管理员在登录系统管理员门户时收到此邮件。                         |
...
| 主题               | 变量                                                | 描述                                       |
| ---------------- | ------------------------------------------------- | ---------------------------------------- |
| 验证您的邮箱           | n/a                                               | 用户在独立创建账户时收到此邮件。                         |
| 您的邮箱变更           | n/a                                               | 当用户发起更改账户邮箱地址的请求时，会收到此邮件。                |
| 您的主密码提示          | n/a                                               | 用户在登录时请求了主密码提示时，会收到这封邮件。                 |
| 主密码已更改           | n/a                                               | 用户主密码更改时会收到此邮件。                          |
| 您的 Bitwarden 验证码 | n/a                                               | 用户在登录时收到此邮件，如果他们需要输入基于电子邮件的双因素登录或验证新设备 。 |
| 新设备从 {Device} 登录 | {Device} = 设备类型，例如 "Chrome 扩展"、"Windows" 或 "iOS"。 | 当用户从新设备登录其账户时会收到此邮件。                     |
| 检测到失败的登录尝试       | n/a                                               | 当用户多次尝试登录其 Bitwarden 账户失败时，会收到此邮件。       |
| 从{IP}恢复双因素认证     | {IP} = 一个 IP 地址。                                  | 用户在用两步登录的恢复码停用 2FA 时收到此邮件。               |
| 删除您的账户           | n/a                                               | 用户在请求删除其账户时收到此邮件。                        |
| 支付失败             | n/a                                               | 用户在订阅关联的支付方式在续费时失败时收到此邮件。                |
| 账户信用支付处理完成       | n/a                                               | 用户在账户积分用于订阅续费时会收到此邮件。                    |
| 欢迎来到 Bitwarden！  | n/a                                               | 用户在创建新的 Bitwarden 账户时会收到此邮件。             |
| 紧急访问联系人邀请        | n/a                                               | 用户收到此邮件时，他们是 被邀请成为另一位用户的紧急联系人 。          |
| 接受的紧急访问          | n/a                                               | 用户收到此邮件时，另一位用户已 接受邀请成为紧急联系人 。            |
| 您已被确认为紧急访问联系人    | n/a                                               | 用户收到此邮件时，他们是 被确认为另一位用户的紧急联系人 。           |
| 已启动紧急访问          | n/a                                               | 用户在紧急联系人请求访问其账户时收到此邮件。                   |
| 已批准紧急访问          | n/a                                               | 用户在他们的紧急访问他人账户的请求获得批准时收到此邮件。             |
| 紧急访问被拒绝          | n/a                                               | 用户在他们的请求紧急访问他人账户被拒绝时收到此邮件。               |
| 待处理的紧急访问请求       | n/a                                               | 用户在发起的紧急访问请求经过一定时间后仍然悬而未决时收到此邮件。         |
| 紧急访问已授权          | n/a                                               | 用户在他们的账户已被授权给紧急联系人时收到此邮件。                |
