...
要查找自托管服务器的版本，请登录[系统管理员门户](../self-hosting/system-administrator-portal.md)。**服务器**和 **Web** 的版本将列在仪表盘上。如果**已安装**的版本与**最新**版本不匹配，请[更新您的服务器](../self-hosting/update-your-instance.md)：
